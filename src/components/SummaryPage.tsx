        ...
        <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-3 md:gap-4">
            <div className="glass rounded-lg sm:rounded-xl md:rounded-2xl p-3 sm:p-4 md:p-6 text-center shadow-lg slide-up delay-100 card-hover">
              <div className="text-lg sm:text-2xl md:text-3xl mb-0.5 sm:mb-1 md:mb-2">
                ✅
              </div>
              ...
              {wrongWords.length > 0 ? (
                <>
                  <div className="flex justify-between items-center mb-3">
                    <p className="text-xs sm:text-sm text-gray-600 font-medium">
                      Wrong words only ({wrongWords.length} words) /
                      間違えた単語のみ ({wrongWords.length}個)
                    </p>
                    <button
                ...
                <div className="bg-green-50 rounded-lg p-6 border-2 border-green-200 text-center">
                  ...
                  <p className="text-sm text-green-600">
                    No wrong words to display / 間違えた単語はありません
                  </p>
                </div>
              )}
            </div>
